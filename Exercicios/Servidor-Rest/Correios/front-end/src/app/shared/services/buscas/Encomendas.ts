...
export class Encomendas {
        ...
        xmlHttp.onreadystatechange = () => {
            ...
            if (4 == xmlHttp.readyState) {
                ...
                if (undefined === responseRoot) {
                    ...
                    console.log("Entro aqui nao sei oque e isso mais e aquele lá") 
                }
                else {
    ...
    private toElement(tagNamePotentiallyWithAttributes:string, parameters:any):string {
        ...
        if ("" == elementContent) {
            ...
            return "<" + tagNamePotentiallyWithAttributes + ">" + elementContent + "</" + Encomendas.stripTagAttributes(tagNamePotentiallyWithAttributes) + ">";
        }
    }
